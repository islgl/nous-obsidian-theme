...
### Changed
- **Handwriting mode heading ornament spacing** — the flower marks (❃ ✿ ❁) before H1/H2/H3 in reading view were crashing into Obsidian's fold-indicator chevron when a heading was collapsible. First attempt pushed wrong-side margins; second attempt overshot. Final tuning: `margin-right` on H1 ornament 0.65em, H2/H3 ornaments 0.55em, and `margin-left: 0.15em` on the chevron — effective gap ≈ 0.7–0.8em, clearly separated without feeling divorced.
